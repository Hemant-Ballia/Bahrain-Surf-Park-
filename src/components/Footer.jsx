...
const Footer = () => {
  ...
  return (
    <div className="font-outfit">
      <footer
        ref={footerRef}
        className="bg-[#004658] text-white relative"
      >
        {/* Top Wave */}
        <div className="absolute top-0 left-0 w-full h-[30px] md:h-[50px] -translate-y-full z-10 pointer-events-none">
          <svg
            className="w-full h-full block -scale-y-100"
        ...
        {/* Main Footer Content */}
        <div
          className={`relative max-w-[1230px] mx-auto px-4 md:px-8 pt-12 pb-28 md:pb-36 transition-all duration-1000 ease-out ${
            isVisible
        ...
        >
              ...
              <div>
                <a href="#" className="inline-block">
                  <img
                    ...
                    className="h-24 md:h-32 w-auto object-contain footer-logo -ml-2"
                  />
                </a>
              </div>

              <div>
                <h2 className="font-caacupe text-[#fffff2] text-[15px] tracking-[0.1em] uppercase mb-4">
                  Get Started
                </h2>
                ...
                <ul className="flex flex-col gap-2 font-light">
                  <li>
                    <a
                      href="#"
                      className="text-white hover:text-[#00bef0] transition-colors"
                    >
                      Start
                    </a>
                  </li>
                ...
                <a
                  href="#booking"
                  className="mt-6 inline-flex items-center justify-center bg-[#00E599] text-slate-900 rounded-[21px] text-[11px] font-bold tracking-[0.12em] uppercase px-[30px] py-[12px] hover:bg-[#fffff2] hover:text-[#004658] transition-all duration-300 hover:-translate-y-1"
                >
                  Book Now
                </a>
              </div>
          ...
          {/* Social Icons Amoeba */}
          <div className="absolute bottom-0 right-0 w-[236px] h-[54px] hidden md:block">
            <svg
              className="absolute top-0 left-0 w-full h-full fill-[#027b9a]"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 236 54"
            >
              <path
            ...
            <a
              href="#"
              className="absolute left-[3px] top-[11px] p-[10px] group"
            >
              <svg
                className="w-[18px] h-[18px] fill-[#fffff2] group-hover:fill-[#00bef0] transition-colors"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 30 30"
              >
            ...
            <a
              href="#"
              className="absolute left-[62px] top-[3px] p-[10px] group"
            >
              <svg
                className="w-[18px] h-[18px] fill-[#fffff2] group-hover:fill-[#00bef0] transition-colors"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              href="#"
              className="absolute left-[123px] top-[12px] p-[10px] group"
            >
              <svg
                className="w-[18px] h-[18px] fill-[#fffff2] group-hover:fill-[#00bef0] transition-colors"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              href="#"
              className="absolute left-[172px] top-[7px] p-[10px] group"
            >
              <svg
                className="w-[22px] h-[22px] fill-[#fffff2] group-hover:fill-[#00bef0] transition-colors"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32"
              >
        ...
        {/* Copyright */}
        <div className="bg-[#027b9a] text-white py-[15px] px-[30px] text-center w-full">
          <div className="max-w-[1200px] mx-auto">
            <p className="text-[13px] font-light leading-[18px] m-0">
              <a
                href="#"
                className="text-white hover:text-[#fffff2] transition-colors"
              >
                © {new Date().getFullYear()} Bahrain Surf Park. | All rights
                reserved.
              </a>
            </p>
          </div>
